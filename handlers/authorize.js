...
// Passes through our `checkIn` policy, then returns a very specifically formatted
// object that AWS uses to determine wether we should go next or not.
//
// As always, Amazon official docs are incredible and beautifully detailed:
